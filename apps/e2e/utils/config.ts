...
export function getTestConfig(): TestConfig {
  ...
  return {
    ...
    database: {
      url: process.env.DATABASE_URL || 'postgresql://postgres:postgres@localhost:5432/refref',
    },

    testUser: {
      email: process.env.TEST_USER_EMAIL || 'e2e_test_admin@refref.com',
      password: process.env.TEST_USER_PASSWORD || 'TestPassword123!',
      organizationName: process.env.TEST_ORGANIZATION_NAME || 'E2E Test Organization',
