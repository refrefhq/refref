        ...
        <div className="grid gap-8 md:grid-cols-12">
          ...
          <div className="md:col-span-4">
            <div className="flex gap-4 mb-4">
              <Link href="https://www.linkedin.com/company/refrefhq" className="text-muted-foreground hover:text-foreground">
                <LinkedInIcon />
              </Link>
              <Link href="https://x.com/refrefhq" className="text-muted-foreground hover:text-foreground">
                <TwitterIcon />
              </Link>
