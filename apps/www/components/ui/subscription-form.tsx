...
export function SubscriptionForm({
  ...
  return (
    <>
      {showHeader && (
        <>
          ...
          <h2 className="mb-3 text-pretty text-3xl font-semibold md:mb-4 md:text-4xl lg:mb-6 lg:max-w-3xl lg:text-5xl">
            RefRef <span className="animate-text-gradient inline-flex bg-gradient-to-r from-neutral-900 via-slate-500 to-neutral-500 bg-[200%_auto] bg-clip-text leading-tight text-transparent dark:from-neutral-100 dark:via-slate-400 dark:to-neutral-400">Blog</span>
          </h2>
      ...
      <form action="https://submit-form.com/ZQzighfzx" className={`flex flex-col ${variant === 'blog' ? 'items-center' : ''} gap-4`}>
