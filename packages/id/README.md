...
// ['user', 'project', 'program', 'participant', ...]
```
...
try {
  ...
  if (error instanceof InvalidEntityError) {
    ...
    // Invalid entity type: invalid. Valid types are: user, project, program, ...
  }
}
```
...
| project          | prj    | prj_cm4d2e6f000000h0i2c4d5e6f     |
| projectUser      | pju    | pju_cm5e3f7g000000i0j3d5e6f7g     |
...
| projectSecrets   | sec    | sec_cmen2o6p000000r0s2m4n5o6p     |
